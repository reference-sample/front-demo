...
const downloadFileClick = async () => {
  ...
  const fileMd5 = await downloadFile("f4daabea-51ec-466d-a490-5c7827e2fcd7-Fira_Code_v6.2.zip")
...
const downloadFileChunkClick = async () => {
  console.info('开始分块下载...')
  const start = new Date().getTime()
  const fileName = "f4daabea-51ec-466d-a490-5c7827e2fcd7-Fira_Code_v6.2.zip"
